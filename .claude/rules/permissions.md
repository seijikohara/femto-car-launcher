...
| `com.android.vending.BILLING` | Query and launch Google Play subscription purchases for the paid Mapbox map backend. Normal protection; auto-granted at install. |
