...
// .oxlintrc.json and no-let.js). All camera pushes and style ops read+write through here.
const state = {
...
function initMap(): void {
    ...
    try {
        ...
        window.setMapboxStyle = (styleId, lightPreset, traffic) => {
            ...
            if (
                styleApplyMode(url, state.appliedStyleUrl, liveMap.isStyleLoaded()) === "apply-now"
            ) {
