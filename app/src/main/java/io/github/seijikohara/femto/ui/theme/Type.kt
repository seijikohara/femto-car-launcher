 ...
 * [FemtoDimens.Text4Xl]. One style for both cards keeps their heroes on one digit
 * band across the row, and it is theirs to move without touching the clock's
 * ([clockHero]).
 */
internal fun Typography.cardHero(): TextStyle = bigNumber(size = FemtoDimens.Text4Xl, weight = normalWeight)
